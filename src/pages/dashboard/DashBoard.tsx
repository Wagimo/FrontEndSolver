...
import { GetAll } from "@/services/VouchersServices";
  ...
  return (
    <div className="h-screen w-full ">
      <div className="mx-3 mt-20">
        ...
        <div className="mt-5 md:flex flex-wrap md:justify-between justify-center flex ">
          {GetAll()
            .slice(0, 4)
            .map((voucher) => (
              <VoucherCardComponent key={voucher.id} voucher={voucher} />
            ))}
        </div>
